function [residual, g1, g2, g3] = nt_mf_dynamic(y, x, params, steady_state, it_)
%
...
residual(9)= lhs-rhs;
lhs =y(17);
rhs =T79*((1+params(17))*params(12)*(y(2)-y(22))+y(14)-y(19));
residual(10)= lhs-rhs;
lhs =y(14);
...
if nargout >= 2,
  ...
  g1(9,25)=1;
  g1(10,14)=(-T79);
  g1(10,2)=(-((1+params(17))*params(12)*T79));
  g1(10,17)=1;
  g1(10,19)=T79;
  g1(10,22)=(-(T79*(-((1+params(17))*params(12)))));
  g1(11,1)=(-params(13));
  g1(11,14)=1;
  g1(11,42)=(-1);
  g1(12,5)=(-params(13));
