...
erase_compiled_function('nt_mf_static');
erase_compiled_function('nt_mf_dynamic');
M_.orig_eq_nbr = 23;
M_.eq_nbr = 27;
M_.ramsey_eq_nbr = 0;
...
save /Users/maximilianbrill/Desktop/Brill&Wolf/MATLAB/results/igp_mf igp_mf
names = ["output", 'consumption' , "ann. real rate", "ann. inflation(qar)", "ann. inflation(yoy)", "ann. nominal rate", "debt", "debt-output ratio", "money growth", "government purchases", "taxes"];
save /Users/maximilianbrill/Desktop/Brill&Wolf/MATLAB/results/names names
welfare_igp_mf = oo_.endo_simul(strmatch('uV',M_.endo_names,'exact'),2:30);
save /Users/maximilianbrill/Desktop/Brill&Wolf/MATLAB/results/welfare_igp_mf welfare_igp_mf;
%
% SHOCKS instructions
%
M_.det_shocks = [ M_.det_shocks;
...
tax_mf = [oo_.endo_simul(strmatch('yV',M_.endo_names,'exact'),2:30);...
            ...
            oo_.endo_simul(strmatch('gV',M_.endo_names,'exact'),2:30);...
            oo_.endo_simul(strmatch('tV',M_.endo_names,'exact'),2:30)];
save /Users/maximilianbrill/Desktop/Brill&Wolf/MATLAB/results/tax_mf tax_mf
welfare_tax_mf = oo_.endo_simul(strmatch('uV',M_.endo_names,'exact'),2:30);
save /Users/maximilianbrill/Desktop/Brill&Wolf/MATLAB/results/welfare_tax_mf welfare_tax_mf;
save('nt_mf_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('nt_mf_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('nt_mf_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('nt_mf_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('nt_mf_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('nt_mf_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('nt_mf_results.mat', 'oo_recursive_', '-append');
end
