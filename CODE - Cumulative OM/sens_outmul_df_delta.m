...
diary off;
diary('sens_outmul_df_delta.log');
M_.exo_names = 'epstV';
...
erase_compiled_function('sens_outmul_df_delta_static');
erase_compiled_function('sens_outmul_df_delta_dynamic');
M_.orig_eq_nbr = 18;
M_.eq_nbr = 20;
M_.ramsey_eq_nbr = 0;
...
oo_.steady_state(19)=oo_.steady_state(11);
...
save /Users/maximilianbrill/Desktop/Brill&Wolf/MATLAB/results/com_tax_df_delta com_tax_df
save /Users/maximilianbrill/Desktop/Brill&Wolf/MATLAB/results/com_igp_df_delta com_igp_df
save('sens_outmul_df_delta_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('sens_outmul_df_delta_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('sens_outmul_df_delta_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('sens_outmul_df_delta_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('sens_outmul_df_delta_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('sens_outmul_df_delta_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('sens_outmul_df_delta_results.mat', 'oo_recursive_', '-append');
end
