...
erase_compiled_function('LT_benchmark_static');
erase_compiled_function('LT_benchmark_dynamic');
M_.orig_eq_nbr = 24;
M_.eq_nbr = 26;
M_.ramsey_eq_nbr = 0;
...
zlb_benchmark = [oo_.endo_simul(strmatch('yV',M_.endo_names,'exact'),2:30);...
...
save /Users/maximilianbrill/Desktop/Brill&Wolf/MATLAB/results/zlb_benchmark zlb_benchmark
names_zlb = ["output", 'consumption' , "ann. real rate", "ann. inflation(qar)", "ann. inflation(yoy)", "ann. nominal rate", "debt", "debt-output ratio", "money growth", "government purchases", "taxes", "preference shock"];
save /Users/maximilianbrill/Desktop/Brill&Wolf/MATLAB/results/names_zlb names_zlb
welfare_zlb_benchmark = [oo_.endo_simul(strmatch('uV',M_.endo_names,'exact'),2:30)];
save /Users/maximilianbrill/Desktop/Brill&Wolf/MATLAB/results/welfare_zlb_benchmark welfare_zlb_benchmark;
save('LT_benchmark_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('LT_benchmark_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('LT_benchmark_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('LT_benchmark_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('LT_benchmark_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('LT_benchmark_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('LT_benchmark_results.mat', 'oo_recursive_', '-append');
end
