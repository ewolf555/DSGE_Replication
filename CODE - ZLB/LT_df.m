...
M_.exo_names = char(M_.exo_names, 'gammaV');
M_.exo_names_tex = char(M_.exo_names_tex, 'gammaV');
M_.exo_names_long = char(M_.exo_names_long, 'gammaV');
M_.endo_names = 'yV';
...
M_.endo_names = char(M_.endo_names, 'RV_taylor');
M_.endo_names_tex = char(M_.endo_names_tex, 'RV\_taylor');
M_.endo_names_long = char(M_.endo_names_long, 'nominal interest rate Taylor rule');
...
M_.endo_names_long = char(M_.endo_names_long, 'ann. real rate');
...
M_.endo_names = char(M_.endo_names, 'rhoV_ann');
M_.endo_names_tex = char(M_.endo_names_tex, 'rhoV\_ann');
M_.endo_names_long = char(M_.endo_names_long, 'ann. preference shock');
...
M_.endo_names = char(M_.endo_names, 'uV');
M_.endo_names_tex = char(M_.endo_names_tex, 'uV');
M_.endo_names_long = char(M_.endo_names_long, 'uV');
...
M_.param_names = char(M_.param_names, 'rpie');
M_.param_names_tex = char(M_.param_names_tex, 'rpie');
M_.param_names_long = char(M_.param_names_long, 'rpie');
...
erase_compiled_function('LT_df_static');
erase_compiled_function('LT_df_dynamic');
M_.orig_eq_nbr = 24;
M_.eq_nbr = 26;
M_.ramsey_eq_nbr = 0;
...
M_.params( 6 ) = 1.28;
Mw = M_.params( 6 );
M_.params( 7 ) = M_.params(5)*M_.params(6);
Mc = M_.params( 7 );
M_.params( 8 ) = 0.3333333333333333;
varkappa = M_.params( 8 );
M_.params( 9 ) = 7;
eta = M_.params( 9 );
M_.params( 10 ) = 0;
nu = M_.params( 10 );
...
M_.params( 14 ) = 1;
sigma = M_.params( 14 );
M_.params( 16 ) = M_.params(5)/(M_.params(5)-1);
epsilonp = M_.params( 16 );
M_.params( 15 ) = (1-M_.params(4))*(1-M_.params(4)*M_.params(1))*(1-M_.params(3))/(M_.params(4)*(1-M_.params(3)+M_.params(3)*M_.params(16)));
lambda = M_.params( 15 );
M_.params( 17 ) = 0.005;
rho = M_.params( 17 );
M_.params( 18 ) = 1.5;
...
oo_.steady_state( 20 ) = 4*oo_.steady_state(16);
oo_.steady_state( 19 ) = 4*oo_.steady_state(12);
oo_.steady_state( 18 ) = 4*oo_.steady_state(5);
oo_.steady_state( 22 ) = 4*oo_.steady_state(10);
oo_.steady_state(25)=oo_.steady_state(12);
...
struct('exo_det',0,'exo_id',1,'multiplicative',0,'periods',1:6,'value',0) ];
M_.det_shocks = [ M_.det_shocks;
struct('exo_det',0,'exo_id',2,'multiplicative',0,'periods',1:6,'value',0.01) ];
M_.det_shocks = [ M_.det_shocks;
struct('exo_det',0,'exo_id',3,'multiplicative',0,'periods',1:6,'value',(-0.01)) ];
M_.exo_det_length = 0;
steady;
...
zlb_igp_df = [oo_.endo_simul(strmatch('yV',M_.endo_names,'exact'),2:30);...
            ...
            oo_.endo_simul(strmatch('rhoV_ann',M_.endo_names,'exact'),2:30);];
save /Users/maximilianbrill/Desktop/Brill&Wolf/MATLAB/results/zlb_igp_df zlb_igp_df
welfare_zlb_igp_df_small = [oo_.endo_simul(strmatch('uV',M_.endo_names,'exact'),2:30)];
save /Users/maximilianbrill/Desktop/Brill&Wolf/MATLAB/results/welfare_zlb_igp_df_small welfare_zlb_igp_df_small;
%
% SHOCKS instructions
%
M_.det_shocks = [ M_.det_shocks;
struct('exo_det',0,'exo_id',1,'multiplicative',0,'periods',1:6,'value',0.01) ];
M_.det_shocks = [ M_.det_shocks;
struct('exo_det',0,'exo_id',2,'multiplicative',0,'periods',1:6,'value',0) ];
M_.det_shocks = [ M_.det_shocks;
struct('exo_det',0,'exo_id',3,'multiplicative',0,'periods',1:6,'value',(-0.01)) ];
M_.exo_det_length = 0;
steady;
...
perfect_foresight_setup;
perfect_foresight_solver;
zlb_tax_df = [oo_.endo_simul(strmatch('yV',M_.endo_names,'exact'),2:30);...
            oo_.endo_simul(strmatch('cV',M_.endo_names,'exact'),2:30);...
            oo_.endo_simul(strmatch('rrV_ann',M_.endo_names,'exact'),2:30);...
            oo_.endo_simul(strmatch('pieV_ann',M_.endo_names,'exact'),2:30);...
            oo_.endo_simul(strmatch('pieyoyV_ann',M_.endo_names,'exact'),2:30);...
            ...
            oo_.endo_simul(strmatch('tV',M_.endo_names,'exact'),2:30);...
            oo_.endo_simul(strmatch('rhoV_ann',M_.endo_names,'exact'),2:30);];
save /Users/maximilianbrill/Desktop/Brill&Wolf/MATLAB/results/zlb_tax_df zlb_tax_df
welfare_zlb_tax_df_small = [oo_.endo_simul(strmatch('uV',M_.endo_names,'exact'),2:30)];
save /Users/maximilianbrill/Desktop/Brill&Wolf/MATLAB/results/welfare_zlb_tax_df_small welfare_zlb_tax_df_small;
save('LT_df_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('LT_df_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('LT_df_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('LT_df_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('LT_df_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('LT_df_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('LT_df_results.mat', 'oo_recursive_', '-append');
end
