...
M_.endo_names = char(M_.endo_names, 'RV_new');
M_.endo_names_tex = char(M_.endo_names_tex, 'RV\_new');
M_.endo_names_long = char(M_.endo_names_long, 'nominal interest rate NEW');
...
M_.endo_names_long = char(M_.endo_names_long, 'byoyV');
...
erase_compiled_function('impact_zlb_mf_static');
erase_compiled_function('impact_zlb_mf_dynamic');
M_.orig_eq_nbr = 24;
M_.eq_nbr = 26;
M_.ramsey_eq_nbr = 0;
...
struct('exo_det',0,'exo_id',1,'multiplicative',0,'periods',1:2,'value',0) ];
M_.det_shocks = [ M_.det_shocks;
struct('exo_det',0,'exo_id',2,'multiplicative',0,'periods',1:2,'value',0.01) ];
M_.det_shocks = [ M_.det_shocks;
struct('exo_det',0,'exo_id',3,'multiplicative',0,'periods',1:1,'value',0) ];
M_.exo_det_length = 0;
steady;
...
load('/Users/maximilianbrill/Desktop/Gali-Matlab/resultsIM/zlb_benchmark_0.mat');
y_bench = zlb_benchmark;
y_new = (yV(2) - y_bench)*100
g_new = gV(2)*100
impact_zlb_igp_mf = y_new/g_new
save /Users/maximilianbrill/Desktop/Gali-Matlab/resultsIM/impact_zlb_igp_mf_0 impact_zlb_igp_mf
save('impact_zlb_mf_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('impact_zlb_mf_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('impact_zlb_mf_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('impact_zlb_mf_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('impact_zlb_mf_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('impact_zlb_mf_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('impact_zlb_mf_results.mat', 'oo_recursive_', '-append');
end
