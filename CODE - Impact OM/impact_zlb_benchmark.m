...
diary off;
diary('impact_zlb_benchmark.log');
M_.exo_names = 'epstV';
...
erase_compiled_function('impact_zlb_benchmark_static');
erase_compiled_function('impact_zlb_benchmark_dynamic');
M_.orig_eq_nbr = 23;
M_.eq_nbr = 25;
M_.ramsey_eq_nbr = 0;
...
M_.det_shocks = [ M_.det_shocks;
struct('exo_det',0,'exo_id',3,'multiplicative',0,'periods',1:1,'value',(-0.01)) ];
M_.exo_det_length = 0;
steady;
...
save('impact_zlb_benchmark_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('impact_zlb_benchmark_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('impact_zlb_benchmark_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('impact_zlb_benchmark_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('impact_zlb_benchmark_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('impact_zlb_benchmark_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('impact_zlb_benchmark_results.mat', 'oo_recursive_', '-append');
end
