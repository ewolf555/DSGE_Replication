...
erase_compiled_function('impact_zlb_df_static');
erase_compiled_function('impact_zlb_df_dynamic');
M_.orig_eq_nbr = 23;
M_.eq_nbr = 25;
M_.ramsey_eq_nbr = 0;
...
oo_.steady_state(24)=oo_.steady_state(12);
...
M_.det_shocks = [ M_.det_shocks;
struct('exo_det',0,'exo_id',2,'multiplicative',0,'periods',1:2,'value',0.01) ];
M_.det_shocks = [ M_.det_shocks;
struct('exo_det',0,'exo_id',3,'multiplicative',0,'periods',1:10,'value',(-0.01)) ];
M_.exo_det_length = 0;
steady;
...
perfect_foresight_setup;
perfect_foresight_solver;
load('/Users/maximilianbrill/Desktop/Gali-Matlab/resultsIM/zlb_benchmark_10.mat');
y_bench = zlb_benchmark;
y_new = (yV(2) - y_bench)*100
g_new = gV(2)*100
impact_zlb_igp_df = y_new/g_new
save /Users/maximilianbrill/Desktop/Gali-Matlab/resultsIM/impact_zlb_igp_df_10 impact_zlb_igp_df
save('impact_zlb_df_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('impact_zlb_df_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('impact_zlb_df_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('impact_zlb_df_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('impact_zlb_df_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('impact_zlb_df_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('impact_zlb_df_results.mat', 'oo_recursive_', '-append');
end
